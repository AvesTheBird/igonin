...
declare class MarkerShape {
     ...
     */
    static createMarker(canvas: AbstractCanvas2D, shape: Shape, type: ArrowValue | string, pe: Point, unitX: number, unitY: number, size: number, source: boolean, sw: number, filled: boolean): any;
}
